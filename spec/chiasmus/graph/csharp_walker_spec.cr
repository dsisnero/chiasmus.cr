...
describe "C# graph walker" do
  if TreeSitterManager::GrammarLoader.tree_sitter_available?("csharp")
    ...
    pending "extracts class declarations from C# source (csharp grammar not available)"
    pending "extracts interface declarations (csharp grammar not available)"
    pending "extracts struct and enum declarations (csharp grammar not available)"
    pending "extracts constructor declarations (csharp grammar not available)"
    pending "captures method calls between classes (csharp grammar not available)"
    pending "captures using directives as imports (csharp grammar not available)"
    pending "handles namespace scoping (csharp grammar not available)"
    pending "extracts summary from C# files (csharp grammar not available)"
  end
end
