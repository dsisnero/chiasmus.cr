...
describe "PHP graph walker" do
  if Chiasmus::Discovery::GrammarLoader.tree_sitter_available?("php")
    ...
    pending "extracts class declarations and methods (php grammar not available)"
    pending "extracts function definitions (php grammar not available)"
    pending "captures function calls (php grammar not available)"
    pending "captures namespace use clauses (php grammar not available)"
    pending "produces file nodes for PHP files (php grammar not available)"
  end
end
