...
describe "C graph walker" do
  if Chiasmus::Discovery::GrammarLoader.tree_sitter_available?("c")
    ...
    pending "extracts function definitions (c grammar not available)"
    pending "extracts struct declarations (c grammar not available)"
    pending "extracts enum declarations as types (c grammar not available)"
    pending "captures function calls (c grammar not available)"
    pending "captures #include directives as imports (c grammar not available)"
    pending "produces file nodes for C files (c grammar not available)"
  end
end
