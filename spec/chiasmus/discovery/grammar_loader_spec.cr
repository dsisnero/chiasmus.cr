...
describe Chiasmus::Discovery::GrammarLoader do
  it "returns a snapshot of registered grammar directories instead of the shared backing array" do
    ...
    begin
      Chiasmus::Discovery::GrammarLoader.clear_registered_directories_for_test
      Chiasmus::Discovery::GrammarLoader.register_grammar_directory(tmpdir)

      snapshot = Chiasmus::Discovery::GrammarLoader.grammar_directories
      snapshot.clear

      Chiasmus::Discovery::GrammarLoader.grammar_directories.should eq([tmpdir])
    ensure
      Chiasmus::Discovery::GrammarLoader.clear_registered_directories_for_test
