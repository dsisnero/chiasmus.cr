...
pointer advanced to `55d43881` (upstream v0.1.27–v0.1.28) on 2026-09-07. P63 is
now reconciled; the remaining new source and test declarations are explicitly
scoped to P64 below. The counts therefore describe the last reconciled baseline,
not an assertion that the remaining vendor surface is already closed.
